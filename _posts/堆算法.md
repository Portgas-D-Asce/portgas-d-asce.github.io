...
默认大根堆，child 每轮都会前进一步，parent 每两轮前进一步
...
从父结点开始 “维护堆”：如果 parent 小于 value 则将 parent 下移，否则找到插入位置。
...
- 从堆顶元素开始维护堆：左右子节点中较大者移动到 parent 位置
- 从 holeIndex 开始：自底向上维护堆
